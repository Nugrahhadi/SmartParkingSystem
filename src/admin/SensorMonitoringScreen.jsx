              ...
              {sensors.map(sensor => (
                <div 
                  ...
                  className={`p-3 border-b hover:bg-gray-50 cursor-pointer ${
                    selectedSensor?.id === sensor.id ? 'bg-blue-50 border-l-4 border-l-blue-500' : ''
                  }`}
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <div className="flex items-center text-sm text-gray-600 mt-1">
                        ...
                        {sensor.location}, Level {sensor.level}, Slot {sensor.slot}
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    <div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-2 text-xs font-medium">{sensor.battery}%</span>
                      </div>
                    </div>
                    <div>
                          ...
                          {[1, 2, 3, 4].map(bar => (
                            <div 
                              ...
                              className={`w-1 rounded-sm ${
                                bar * 25 <= sensor.signal ? 'bg-green-500' : 'bg-gray-200'
                              }`}
                              style={{ height: `${5 + bar * 2}px` }}
                            ></div>
                          ))}
                        </div>
                        <span className="ml-2 text-xs font-medium">{sensor.signal}%</span>
                      </div>
                    </div>
                  </div>
          ...
          <div className="col-span-2">
            {selectedSensor ? (
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white rounded-lg shadow-sm p-4">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <p className="text-gray-600">{selectedSensor.type} Sensor</p>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-sm">Level {selectedSensor.level}, Slot {selectedSensor.slot}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-medium">{selectedSensor.installDate}</p>
                    </div>
                    <div>
                  ...
                  <div className="mt-4">
                    ...
                    <div className="flex items-center">
                      <Battery size={20} className={`mr-2 ${
                        selectedSensor.battery < 20 ? 'text-red-500' : 
                        selectedSensor.battery < 50 ? 'text-yellow-500' : 'text-green-500'
                      }`} />
                  ...
                  <div className="mt-4">
                    <p className="text-sm text-gray-500 mb-2">Signal Strength</p>
                    <div className="flex items-center">
                      <Wifi size={20} className={`mr-2 ${
                        selectedSensor.signal < 20 ? 'text-red-500' : 
                        selectedSensor.signal < 50 ? 'text-yellow-500' : 'text-green-500'
                      }`} />
                      <div className="flex-grow">
                        <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                          <div 
                            className={`h-full ${
                              selectedSensor.signal < 20 ? 'bg-red-500' : 
                              selectedSensor.signal < 50 ? 'bg-yellow-500' : 'bg-green-500'
                            }`} 
                            style={{ width: `${selectedSensor.signal}%` }}
                          ></div>
                        </div>
                      </div>
                      <span className="ml-2 font-medium">{selectedSensor.signal}%</span>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-4">
                  <h3 className="font-bold text-gray-800 mb-4">Sensor Activity (24h)</h3>
                  ...
                  <div className="h-64">
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        ...
                        <Tooltip />
                        <Line type="monotone" dataKey="signal" stroke="#3B82F6" strokeWidth={2} />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                  ...
                  <div className="mt-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="p-2 bg-gray-50 rounded">
                        <span className="text-gray-400">Yesterday 08:45 PM</span>
                        <p>Status check: operational</p>
                      </div>
                    </div>
                    <button className="text-blue-600 text-sm font-medium mt-2">View Full Log</button>
                  </div>
                </div>
                
                {/* Parking Slot Status */}
                <div className="bg-white rounded-lg shadow-sm p-4 col-span-2">
                  <h3 className="font-bold text-gray-800 mb-4">Parking Slot Status</h3>
                  ...
                  <div className="bg-blue-50 p-3 rounded-lg flex items-center">
                    ...
                    <div>
                      <p className="font-medium">Slot {selectedSensor.level}-{selectedSensor.slot}</p>
                      <p className="text-sm text-gray-600">Currently occupied by vehicle</p>
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-4">
                    <div className="border border-gray-200 rounded-lg p-3">
                      ...
                      <p className="text-sm text-gray-600">Avg. duration: 1h 20m</p>
                    </div>
                    <div className="border border-gray-200 rounded-lg p-3">
              ...
              <div className="bg-white rounded-lg shadow-sm p-8 h-full flex flex-col items-center justify-center">
                ...
                <h3 className="text-xl font-medium text-gray-700 mb-2">No sensor selected</h3>
                <p className="text-gray-500 text-center max-w-md">
                  Select a sensor from the list to view detailed information, status, and activity data.
                </p>
              </div>
            )}
          </div>
